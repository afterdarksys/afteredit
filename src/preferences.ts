export const editorDefaults = {
  ...
  tabSize: 2, insertSpaces: true, wordWrap: 'off' as 'on' | 'off',
...
export function editorOptions(prefs: EditorPreferences) {
  const { keymap: _keymap, theme: _theme, trimTrailingWhitespace: _trim, insertFinalNewline: _newline, minimap, bracketPairColorization, stickyScroll, ...rest } = prefs;
